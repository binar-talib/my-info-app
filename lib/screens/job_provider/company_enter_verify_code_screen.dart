...
class CompanyEnterVerifyCodeScreen extends StatefulWidget {
  ...
  State<CompanyEnterVerifyCodeScreen> createState() =>
      _CompanyEnterVerifyCodeScreenState();
}

class _CompanyEnterVerifyCodeScreenState
    extends State<CompanyEnterVerifyCodeScreen> {
  @override
  void initState() {
    super.initState();
    registerUser();
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Enter the code sent to company mobile number',
